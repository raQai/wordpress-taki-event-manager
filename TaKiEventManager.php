 ...
 * Description: Erstellen und Darstellen von Events für Tageskinder-Heilbronn
 * Author: Patrick Bogdan
 * Version: 0.0.1
...
include BIWS_TaKiEventManager__PLUGIN_DIR_PATH . 'includes/autoloader.inc.php';
...
if (class_exists('BIWS\\CPTBuilder\\cpt\\CustomPostTypeBuilder')) {
    ...
    require_once BIWS_TaKiEventManager__PLUGIN_DIR_PATH . 'view/Shortcode.php';
}
